  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="w-full flex items-center justify-center mt-auto gap-4">
        ...
        <Link
          href={`/product?category=pizza&id=${id}&size=medium&dough=traditional`}
          className="pt-2 pb-2 pl-4 pr-4 bg-orange-300 rounded-md text-white transition-colors hover:bg-orange-400"
        >
          Выбрать
        </Link>
      </div>
